...
Birim ücret formülleri, vergi parametreleri ve kalem eşlemesi resmi değerlerle **tutarlı**. Eksikler: EDYGG ayrımı (opsiyonel), merkezi sınav rol çeşitliliği, ünvan bazlı katsayılar, GV kademeli tarife uygulaması.
