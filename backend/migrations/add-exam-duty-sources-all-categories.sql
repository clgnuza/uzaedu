-- Tüm sınav görevi kategorileri (meb, osym, aof, ataaof, auzef, ankuzef) için kaynakları ekle/güncelle
...
-- Güncel Eğitim (Agregatör) - TÜM kategorilere detect_category_per_item ile dağıtır (meb, osym, aof, ataaof, auzef, ankuzef)
...
VALUES (
  ...
  E's\u0131nav,g\u00F6rev,g\u00F6zetmen,ba\u015Fvuru,\u00D6SYM,MEB,A\u00D6F,LGS,a\u00E7\u0131k \u00F6\u011Fretim,ATA-A\u00D6F,ATA A\u00D6F,AUZEF,ANKUZEF',
  true,
  0
