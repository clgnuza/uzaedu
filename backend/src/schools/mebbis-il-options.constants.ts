/** MEBBİS kurumlistesi.aspx `cmbil` value → Türkçe il adı (formdaki kodlarla uyumlu). */
export const MEBBIS_IL_OPTIONS: { value: string; label: string }[] = [
  { value: '1', label: 'Adana' },
