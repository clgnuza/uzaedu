...
export const DERS_DAGIT_RULE_CATALOG: DersDagitRuleDef[] = [
  ...
  {
    key: 'not_consecutive_same_hour',
    label_tr: 'Aynı gün bitişik saatte olamaz',
    kind: 'soft',
    default_active: false,
    default_weight: 8,
  },
  {
    key: 'max_days_per_week_planning',
    label_tr: 'Haftada en fazla ders günü',
    kind: 'soft',
    default_active: false,
    default_weight: 9,
  },
  {
    key: 'max_same_period_week',
    label_tr: 'Haftada aynı saatte en fazla X gün',
    kind: 'soft',
    default_active: false,
    default_weight: 7,
  },
  {
    key: 'no_compact_week',
    label_tr: 'Haftaya yayılım (müfredattan hızlı yerleşim yok)',
    kind: 'soft',
    default_active: false,
    default_weight: 8,
  },
