...
export class ExtraLessonParamsService implements OnModuleInit {
  ...
  private getCanonicalLineItemTemplateRows(): TemplateRow[] {
    return [
      ...
      { key: 'edygg_gunduz', label: 'EDYGG-Gündüz', type: 'hourly', indicator_day: 140, indicator_night: null, sort_order: 3 },
      { key: 'edygg_gece', label: 'EDYGG-Gece', type: 'hourly', indicator_day: 150, indicator_night: null, sort_order: 4 },
      { key: 'nobet', label: 'Nöbet Ücreti', type: 'hourly', indicator_day: 140, indicator_night: null, sort_order: 5 },
      { key: 'belleticilik', label: 'Belletmenlik', type: 'hourly', indicator_day: 140, indicator_night: null, sort_order: 6 },
      { key: 'sinav_gorevi', label: 'Sınav Görevi', type: 'hourly', indicator_day: 140, indicator_night: null, sort_order: 7 },
      { key: 'egzersiz', label: 'Egzersiz', type: 'hourly', indicator_day: 140, indicator_night: null, sort_order: 8 },
      { key: 'hizmet_ici', label: 'Hizmet İçi', type: 'hourly', indicator_day: 140, indicator_night: null, sort_order: 9 },
      { key: 'ozel_egitim_25_gunduz', label: '%25 Gündüz', type: 'hourly', indicator_day: 175, indicator_night: 187.5, sort_order: 10 },
      { key: 'ozel_egitim_25_gece', label: '%25 Gece', type: 'hourly', indicator_day: 187.5, indicator_night: null, sort_order: 11 },
      { key: 'edygg_25_gunduz', label: 'EDYGG-%25 Gündüz', type: 'hourly', indicator_day: 175, indicator_night: null, sort_order: 12 },
      { key: 'edygg_25_gece', label: 'EDYGG-%25 Gece', type: 'hourly', indicator_day: 187.5, indicator_night: null, sort_order: 13 },
      { key: 'ozel_egitim_25_nobet', label: '%25 Nöbet Ücreti', type: 'hourly', indicator_day: 175, indicator_night: null, sort_order: 14 },
      { key: 'ozel_egitim_25_belleticilik', label: '%25 Belletmenlik', type: 'hourly', indicator_day: 175, indicator_night: null, sort_order: 15 },
      { key: 'destek_odasi_25', label: 'Destek Odası %25', type: 'hourly', indicator_day: 175, indicator_night: null, sort_order: 16 },
      { key: 'evde_egitim_25', label: 'Evde Eğitim %25', type: 'hourly', indicator_day: 175, indicator_night: null, sort_order: 17 },
      { key: 'cezaevi_gunduz', label: 'Cezaevi Görevi Gündüz', type: 'hourly', indicator_day: 175, indicator_night: 187.5, sort_order: 18 },
      { key: 'cezaevi_gece', label: 'Cezaevi Görevi Gece', type: 'hourly', indicator_day: 187.5, indicator_night: null, sort_order: 19 },
      { key: 'takviye_gunduz', label: 'Takviye Kursu-Gündüz', type: 'hourly', indicator_day: 280, indicator_night: 300, sort_order: 20 },
      { key: 'takviye_gece', label: 'Takviye Kursu-Gece', type: 'hourly', indicator_day: 300, indicator_night: null, sort_order: 21 },
      { key: 'iyep_gunduz', label: 'İYEP-Gündüz', type: 'hourly', indicator_day: 140, indicator_night: null, sort_order: 22 },
      { key: 'iyep_gece', label: 'İYEP-Gece', type: 'hourly', indicator_day: 150, indicator_night: null, sort_order: 23 },
    ];
  }
