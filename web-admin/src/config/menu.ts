...
export const MENU_SIDEBAR: MenuConfig = [
  ...
  {
    title: 'BİLSEM',
    titleByRole: { teacher: 'BİLSEM modülü' },
    icon: Sparkles,
    allowedRoles: ['teacher', 'school_admin'],
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Veli / Öğrenci',     path: '/mesaj-merkezi/veli-iletisim',  icon: Users,      allowedRoles: ['teacher', 'school_admin'], requiredSchoolModule: 'messaging' },
      ...
      { title: 'Devamsızlık',        path: '/mesaj-merkezi/devamsizlik',    icon: FileText,   allowedRoles: ['teacher', 'school_admin'], requiredSchoolModule: 'messaging' },
      { title: 'Ders Devamsızlık',   path: '/mesaj-merkezi/ders-devamsizlik',  icon: FileText,    allowedRoles: ['teacher', 'school_admin'], requiredSchoolModule: 'messaging' },
      ...
      { title: 'İzin',               path: '/mesaj-merkezi/izin',              icon: FileText,    allowedRoles: ['teacher', 'school_admin'], requiredSchoolModule: 'messaging' },
      ...
      { title: 'Gruplar',            path: '/mesaj-merkezi/gruplar',           icon: Users,       allowedRoles: ['teacher', 'school_admin'], requiredSchoolModule: 'messaging' },
      { title: 'Veli Toplantısı',   path: '/mesaj-merkezi/veli-toplantisi',   icon: MessageSquare, allowedRoles: ['teacher', 'school_admin'], requiredSchoolModule: 'messaging' },
      { title: 'Davetiye',           path: '/mesaj-merkezi/davetiye',          icon: MessageSquare, allowedRoles: ['teacher', 'school_admin'], requiredSchoolModule: 'messaging' },
  ...
  },
  {
    ...
    menuGroup: 'teal',
    children: [
      { title: 'Gruplar', path: '/sorumluluk-sinav', icon: LayoutGrid, allowedRoles: ['teacher', 'school_admin'], requiredSchoolModule: 'sorumluluk_sinav' },
      { title: 'Öğrenciler', path: '/sorumluluk-sinav/ogrenciler', icon: Users, allowedRoles: ['teacher', 'school_admin'], requiredSchoolModule: 'sorumluluk_sinav' },
      ...
      { title: 'Raporlar', path: '/sorumluluk-sinav/raporlar', icon: FileText, allowedRoles: ['teacher', 'school_admin'], requiredSchoolModule: 'sorumluluk_sinav' },
    ],
  },
  {
...
export const ROUTE_ROLES: Record<string, ('school_admin' | 'superadmin' | 'teacher' | 'moderator')[]> = {
  ...
  '/kelebek-sinav': ['teacher', 'school_admin', 'superadmin', 'moderator'],
  '/kelebek-sinav/sinif-ogrenci': ['teacher', 'school_admin', 'superadmin', 'moderator'],
  '/kelebek-sinav/yerlesim': ['teacher', 'school_admin', 'superadmin', 'moderator'],
  '/kelebek-sinav/ders-ogretmen': ['teacher', 'school_admin', 'superadmin', 'moderator'],
  ...
  '/kelebek-sinav/oturumlar': ['teacher', 'school_admin', 'superadmin', 'moderator'],
  '/kelebek-sinav/sinav-planlama': ['teacher', 'school_admin', 'superadmin', 'moderator'],
  '/kelebek-sinav/ayarlar': ['teacher', 'school_admin', 'superadmin', 'moderator'],
  ...
  '/sorumluluk-sinav': ['school_admin', 'teacher', 'superadmin', 'moderator'],
  '/sorumluluk-sinav/ogrenciler': ['school_admin', 'superadmin', 'moderator'],
  '/sorumluluk-sinav/oturumlar': ['school_admin', 'teacher', 'superadmin', 'moderator'],
  ...
  '/sorumluluk-sinav/raporlar': ['school_admin', 'teacher', 'superadmin', 'moderator'],
  '/sorumluluk-sinav/yoklama': ['school_admin', 'teacher', 'superadmin', 'moderator'],
  ...
  '/mesaj-merkezi/devamsizlik': ['school_admin', 'teacher', 'superadmin', 'moderator'],
  '/mesaj-merkezi/ders-devamsizlik': ['school_admin', 'teacher', 'superadmin', 'moderator'],
  ...
  '/mesaj-merkezi/izin': ['school_admin', 'teacher', 'superadmin', 'moderator'],
  ...
  '/mesaj-merkezi/gruplar': ['school_admin', 'teacher', 'superadmin', 'moderator'],
  '/mesaj-merkezi/veli-toplantisi': ['school_admin', 'teacher', 'superadmin', 'moderator'],
  '/mesaj-merkezi/davetiye': ['school_admin', 'teacher', 'superadmin', 'moderator'],
...
export function getBreadcrumbs(pathname: string, role?: WebAdminRole): BreadcrumbItem[] {
  ...
  if (chain?.length) {
    ...
    if (normalized === '/haberler/ayarlar') {
      ...
      items.push({ label: 'BİLSEM yıllık çalışma planı' });
