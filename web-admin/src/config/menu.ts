  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { title: 'Program Stüdyosu', path: '/ders-dagit/stüdyo', icon: Sparkles, allowedRoles: ['school_admin'] },
          { title: 'Tercihler', path: '/ders-dagit/tercihler', icon: Sparkles, allowedRoles: ['school_admin', 'teacher'] },
          { title: 'Sınıf görünümü', path: '/ders-dagit/veli', icon: Sparkles, allowedRoles: ['school_admin', 'teacher'] },
        ],
      },
      {
