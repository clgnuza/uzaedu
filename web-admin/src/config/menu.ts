  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { title: 'Stüdyo özeti', path: '/ders-dagit/stüdyo', icon: Sparkles, allowedRoles: ['school_admin'] },
          { title: 'Kurulum', path: '/ders-dagit/stüdyo/kurulum', icon: Settings, allowedRoles: ['school_admin'] },
          { title: 'Doğrulama', path: '/ders-dagit/stüdyo/dogrulama', icon: ClipboardCheck, allowedRoles: ['school_admin'] },
          { title: 'Üret', path: '/ders-dagit/stüdyo/uret', icon: Wand2, allowedRoles: ['school_admin'] },
          { title: 'Program editörü', path: '/ders-dagit/stüdyo/program', icon: TableProperties, allowedRoles: ['school_admin'] },
          { title: 'Yayın', path: '/ders-dagit/stüdyo/program?panel=publish', icon: Megaphone, allowedRoles: ['school_admin'] },
          { title: 'Ayarlar', path: '/ders-dagit/stüdyo/ayarlar', icon: SlidersHorizontal, allowedRoles: ['school_admin'] },
...
export const ROUTE_ROLES: Record<string, ('school_admin' | 'superadmin' | 'teacher' | 'moderator')[]> = {
  ...
  '/ders-dagit/stüdyo': ['school_admin'],
  '/ders-dagit/tercihler': ['school_admin', 'teacher'],
  '/ders-dagit/stüdyo/derslikler': ['school_admin'],
  '/ders-dagit/stüdyo/adalet': ['school_admin'],
  '/ders-dagit/stüdyo/ogretmenler': ['school_admin'],
  '/ders-dagit/stüdyo/dogrulama': ['school_admin'],
  '/ders-dagit/stüdyo/dersler': ['school_admin'],
  '/ders-dagit/stüdyo/gruplar': ['school_admin'],
  '/ders-dagit/stüdyo/donem': ['school_admin'],
  '/ders-dagit/stüdyo/kurulum': ['school_admin'],
  '/ders-dagit/stüdyo/atamalar': ['school_admin'],
  '/ders-dagit/stüdyo/kurallar': ['school_admin'],
  '/ders-dagit/stüdyo/uret': ['school_admin'],
  '/ders-dagit/stüdyo/program': ['school_admin'],
  '/ders-dagit/stüdyo/ayarlar': ['school_admin'],
  '/ders-dagit/stüdyo/arsiv': ['school_admin'],
  '/ders-dagit/stüdyo/secmeli': ['school_admin'],
  '/ders-dagit/stüdyo/ogretmen-program': ['school_admin'],
  '/ders-dagit/stüdyo/yayin': ['school_admin'],
...
export const ROUTE_SCHOOL_MODULES: Record<string, string | undefined> = {
  ...
  '/ders-dagit/stüdyo': 'ders_dagit',
  '/ders-dagit/tercihler': 'ders_dagit',
  '/ders-dagit/veli': 'ders_dagit',
  '/ders-dagit/stüdyo/kurulum': 'ders_dagit',
  '/ders-dagit/stüdyo/donem': 'ders_dagit',
  '/ders-dagit/stüdyo/ogretmenler': 'ders_dagit',
  '/ders-dagit/stüdyo/dersler': 'ders_dagit',
  '/ders-dagit/stüdyo/gruplar': 'ders_dagit',
  '/ders-dagit/stüdyo/derslikler': 'ders_dagit',
  '/ders-dagit/stüdyo/atamalar': 'ders_dagit',
  '/ders-dagit/stüdyo/kurallar': 'ders_dagit',
  '/ders-dagit/stüdyo/dogrulama': 'ders_dagit',
  '/ders-dagit/stüdyo/uret': 'ders_dagit',
  '/ders-dagit/stüdyo/program': 'ders_dagit',
  '/ders-dagit/stüdyo/ayarlar': 'ders_dagit',
  '/ders-dagit/stüdyo/yayin': 'ders_dagit',
  '/ders-dagit/stüdyo/adalet': 'ders_dagit',
  '/ders-dagit/stüdyo/arsiv': 'ders_dagit',
  '/ders-dagit/stüdyo/secmeli': 'ders_dagit',
  '/ders-dagit/stüdyo/ogretmen-program': 'ders_dagit',
};
