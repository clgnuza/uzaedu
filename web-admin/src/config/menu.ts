  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { title: 'Stüdyo özeti', path: '/ders-dagit/studyo', icon: Sparkles, allowedRoles: ['school_admin'] },
          ...
          { title: 'Üret', path: '/ders-dagit/studyo/uret', icon: Wand2, allowedRoles: ['school_admin'] },
          { title: 'Program editörü', path: '/ders-dagit/studyo/program', icon: TableProperties, allowedRoles: ['school_admin'] },
