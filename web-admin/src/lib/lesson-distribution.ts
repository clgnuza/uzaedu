/** Haftalık ders dağılımı (2+2, 3+1, …) — blok öncelikli preset sırası */
...
export const DAY_DISTRIBUTION_PRESETS: Record<number, number[][]> = {
  ...
  3: [[2, 1], [1, 1, 1], [3]],
  4: [[2, 2], [3, 1], [2, 1, 1], [4]],
  5: [[2, 2, 1], [3, 2], [2, 1, 1, 1], [2, 1, 2], [5]],
  6: [[3, 3], [2, 2, 2], [3, 2, 1], [2, 2, 1, 1], [6]],
  7: [[3, 2, 2], [4, 3], [2, 2, 2, 1], [7]],
  8: [[4, 4], [3, 3, 2], [2, 2, 2, 2], [8]],
};
