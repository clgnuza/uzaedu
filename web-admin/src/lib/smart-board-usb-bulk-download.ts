...
import { buildSmartBoardUsbLauncherHtml, sanitizeFileBase, triggerBlobDownload } from '@/lib/smart-board-usb-launcher';
...
export async function downloadAllSmartBoardUsbLaunchers(args: {
  ...
  triggerBlobDownload(blob, `${sanitizeFileBase(args.schoolLabel)}_tahta_usb.zip`);
}
