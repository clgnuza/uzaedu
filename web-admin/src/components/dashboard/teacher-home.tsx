      ...
      items: [
        {
          ...
          desc: '1) Oturum 2) Anahtar 3) Tara 4) Sonuç',
          icon: ClipboardList,
        ...
        },
        {
          href: '/optik-formlar',
          title: 'Optik formlar',
          desc: 'Yazdırılacak PDF şablonları',
          icon: ScanLine,
        ...
        },
        {
          ...
          desc: 'Oturumsuz tek kağıt (deneme)',
          icon: ScanBarcode,
          accent: 'from-fuchsia-500/20 to-pink-500/10 text-fuchsia-800 dark:text-fuchsia-300',
          schoolModule: 'optical',
        },
        {
          ...
          desc: 'Sınıf · ders istatistik',
          icon: BarChart3,
          accent: 'from-indigo-500/20 to-violet-500/10 text-indigo-800 dark:text-indigo-300',
          schoolModule: 'optical',
        },
      ],
    },
