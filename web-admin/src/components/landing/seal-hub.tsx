...
const ITEMS: HubItem[] = [
  ...
  {
    label: 'Doğrudan temin',
    href: '/login?redirect=%2Fdogrudan-temin',
    icon: Package,
    description: 'Temin dosyaları, teklifler, bütçe blokları ve ödemeleri yasal çerçevede yürütün.',
    detail: '22/a–22/g süreçleri, belge üretimi ve komisyon adımlarını tek modülde toplar; rapor ve arşivle izlenebilirlik sağlar.',
    tags: ['Teklif', 'Bütçe', 'Rapor'],
  },
  ...
  { label: 'Ajanda', href: '/login?redirect=%2Fogretmen-ajandasi', icon: CalendarClock, description: 'Öğretmen ajandası ile not, görüşme, etkinlik ve takip kayıtlarını düzenleyin.', detail: 'Günlük okul temposunu daha düzenli hale getirir; görüşme, not ve takip adımlarını tek ekranda toplar.', tags: ['Notlar', 'Görüşmeler', 'Takip'] },
  {
    ...
    href: '/login?redirect=%2Fogretmen-ajandasi%2Fdegerlendirme',
    icon: NotebookPen,
    description: 'Sınıf ve öğrenci bazında değerlendirme kayıtlarını ajanda ile birlikte yürütün.',
    detail: 'Ölçütler, notlar ve takip adımlarını düzenli tutar; veli görüşmeleri ve dönem özeti için veri üretir.',
    tags: ['Sınıf', 'Kayıt', 'Takip'],
  },
