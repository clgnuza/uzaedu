...
export type LandingHubItem = {
  label: string;
  /** Dar ekranda halka etiketi (çakışmayı azaltır) */
  shortLabel?: string;
  slug: string;
  href: string;
  icon: LucideIcon;
...
export const LANDING_HUB_ITEMS: LandingHubItem[] = [
  ...
  { label: 'Optik Okuma', shortLabel: 'Optik', slug: 'optik-okuma', href: '/login?redirect=%2Foptik-formlar', icon: ScanLine, description: 'Optik form üretin, okutun ve sonuçları hızlıca raporlayın.', detail: 'Form tasarımından sonuç yorumuna kadar ölçme sürecini sadeleştiren hızlı bir optik okuma deneyimi sunar.', tags: ['Form üret', 'Oku', 'Raporla'] },
  { label: 'Akıllı Tahta', shortLabel: 'Tahta', slug: 'akilli-tahta', href: '/login?redirect=%2Fakilli-tahta', icon: Monitor, description: 'Akıllı tahta oturumları, cihaz yönetimi ve sınıf içi akışı merkezden yönetin.', detail: 'Cihaz erişimi, oturum kurgusu ve sınıf içi kullanım adımlarını tek merkezde toplar.', tags: ['Cihaz', 'Oturum', 'Sınıf içi'] },
  ...
  { label: 'Ders Dağıt', shortLabel: 'Dağıt', slug: 'ders-dagit', href: '/login?redirect=%2Fders-dagit', icon: LayoutGrid, description: 'Ders programı üretimi, öğretmen atamaları ve stüdyo kurallarıyla dağıtımı yönetin.', detail: 'Program stüdyosu, yerleşim motoru ve yayın akışı ile haftalık çizelgeyi kurallara uygun üretir ve okula yayınlar.', tags: ['Program', 'Atama', 'Stüdyo'] },
  ...
  { label: 'Okul Değerl.', shortLabel: 'Değerl.', slug: 'okul-degerlendirme', href: '/okul-degerlendirmeleri', icon: Star, description: 'Okul değerlendirme sayfasını inceleyin, görünürlüğü ve geri bildirimleri takip edin.', detail: 'Okul algısını, yorumları ve görünürlük etkisini daha anlaşılır hale getirir.', tags: ['Geri bildirim', 'Görünürlük', 'Analiz'] },
